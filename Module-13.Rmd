...
Together, the values we have calculated above form the main entries in the ANOVA Table for our regression. (see module)
...
The standard error of intercept B0 is:
...
The SE of each predicted value of y is:
...
summary(m)
```
The higher the r squared (closer to 1) the better the fit of the linear model
You might have the best fit possible for your data, but that doesn't mean it is a good model period, and that's how you use the r squared.
The intercept is the value of y when x = 0
F-statistic - is this adequately describing this relationship? P value is very low. If it wasn't significant, then the model is not soaking up enough variation
## Model Checking
...
At very high quantiles of x, we are violating the normal distribution
