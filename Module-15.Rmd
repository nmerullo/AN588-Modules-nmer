...
see module for this but it's basically sum of y - the equation above squared
...
NOTE TO SELF: This will be helpful for data replication assignment I think
...
p = number of parameters estimated from the data (i.e., the number of β
 coefficients, not including the intercept)
